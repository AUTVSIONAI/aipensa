...
const useStyles = makeStyles((theme) => ({
  ...
  quickMessageDialog: {
    ...
    maxHeight: "50vh", // Altura máxima
    overflow: "hidden", // Esconde o overflow do container principal
    boxShadow: "0px 8px 24px rgba(0, 0, 0, 0.2)", // Sombra mais pronunciada
  },
  quickMessageTitle: {
    backgroundColor: "#3f51b5", // Fundo azul para o título
    color: "#ffffff",
    fontWeight: "bold",
  ...
  quickMessageContent: {
    maxHeight: "calc(80vh - 64px)", // Altura máxima para a lista de botões
    overflowY: "auto", // Barra de rolagem vertical
    padding: theme.spacing(2),
  },
  quickMessageButton: {
    backgroundColor: "#415b73", // Cor dos botões
    color: "#ffffff",
    margin: theme.spacing(0.5),
    borderRadius: 0, // Removido o arredondamento
    padding: "10px 20px",
    fontSize: "12px",
    textTransform: "none",
    width: "100%",
    ...
    "&:hover": {
      backgroundColor: "#385168", // Cor ao passar o mouse
    },
  },
}));
...
const MessageInput = ({ ticketId, ticketStatus, droppedFiles, contactId, ticketChannel, notificameHub }) => {
  ...
  const handleOpenQuickMessagesDialog = () => {
    setQuickMessagesDialogOpen(true);
  };

  const handleCloseQuickMessagesDialog = () => {
