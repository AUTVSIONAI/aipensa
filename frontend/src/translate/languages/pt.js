    ...
    translations: {
      ...
      dashboard: {
        ...
        users: {
          ...
          totalAttendances: "TOTAL DE ATENDIMENTOS POR PERÍODO",
        },
        date: {
      ...
      tagModal: {
        title: {
          add: "Nova Tag",
          edit: "Editar Tag",
          addKanban: "Novo Quadro",
          editKanban: "Editar Quadro",
        },
        form: {
          name: "Nome",
          color: "Cor",
          timeLane: "Tempo em horas para redirecionar para o quadro",
          nextLaneId: "Quadro",
          greetingMessageLane: "Mensagem de saudação do Quadro",
          rollbackLaneId: "Voltar para o Quadro após retomar atendimento"
        },
        buttons: {
          okAdd: "Adicionar",
          okEdit: "Salvar",
        ...
        successKanban: "Quadro salvo com sucesso.",
      },
      fileModal: {
        title: {
      ...
      messagesAPI: {
        ...
        API: {
          ...
          methods: {
            ...
            messagesMidia: "Mensagens com Arquivos",
          },
          instructions: {
            title: "Instruções",
      ...
      tagsKanban: {
        ...
        confirmationModal: {
          deleteTitle: "Você tem certeza que quer excluir este Quadro?",
          deleteMessage: "Esta ação não pode ser revertida.",
        },
        table: {
          name: "Nome",
        ...
        toasts: {
          deleted: "Quadro excluído com sucesso.",
        },
      },
      ...
      settings: {
        ...
        settings: {
          ...
          options: {
            ...
            creationCompanyUser: "Criação de Empresa/Usuário",
      ...
      messagesList: {
        header: {
          ...
          dialogRatingCancel: "Com Mensagem de Despedida",
          dialogRatingSuccess: "Resolver e Enviar Avaliação",
          dialogRatingWithoutFarewellMsg: "SEM Mensagem de Despedida",
