        ...
        datasets: [
            {
                ...
                backgroundColor: ticketsData?.data.map((_, index) => barColors[index % barColors.length]), // Cores sólidas para cada barra
                borderColor: ticketsData?.data.map((_, index) => barColors[index % barColors.length]), // Bordas com as mesmas cores
                borderWidth: 1,
                hoverBackgroundColor: ticketsData?.data.map((_, index) => barColors[index % barColors.length]), // Cores ao passar o mouse
                hoverBorderColor: '#000', // Cor da borda ao passar o mouse
            },
        ],
    };
